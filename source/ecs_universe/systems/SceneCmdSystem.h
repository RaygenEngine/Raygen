...
template<typename T>
void EnqueueRecreateCmds(Scene_* scene, entt::registry& reg)
{
	{
...
class SceneCmdSystem {
	...
	std::vector<FnPtr<void, Scene_*, entt::registry&>> m_recreateCmds;
...
public:
	...
	static void WriteRecreateCmds(Scene_* scene, entt::registry& registry);
};
