...
void PtBase_SinglePipeline::Utl_CreatePipelineCustomPass(GpuAsset<Shader>& shader,
	vk::PipelineColorBlendStateCreateInfo colorBlending, vk::RenderPass renderPass, uint32 subpassIndex)
{
	std::vector shaderStages = shader.shaderStages;
